---
title: "Scripting: NSX-v – Bulk DFW Rule Creation"
date: 2015-08-26
categories: 
  - "nsx"
  - "scripts"
  - "vmware"
coverImage: "codeimage.png"
---
...
The latest version of the script is hosted on GitHub here ([https://github.com/dcoghlan/NSX-Create-Testing-Rules](https://github.com/dcoghlan/NSX-Create-Testing-Rules)).

As you can see we have a nice fresh install of NSX-v 6.2

[![bulk-fw-testing-rules-01](images/bulk-fw-testing-rules-01-1024x562.png)](http://www.sneaku.com/wp-content/uploads/2015/08/bulk-fw-testing-rules-01.png)

 

The following example will:

- connect to NSX Manager with the IP address 10.29.5.211
...
```
python nsx-create-testing-rules.py --nsxmgr 10.29.5.211 add --section-name "Performance-Testing" --rule-count 171
```
...
Enter NSX Manager password:
Retrieving ETag                                                      [   OK   ]
Creating section and 171 rule[s] via API                             [   OK   ]
...
```
python nsx-create-testing-rules.py  add --section-name "Performance-Testing" --rule-count 171
...
[![bulk-fw-testing-rules-02](images/bulk-fw-testing-rules-02-1024x559.png)](http://www.sneaku.com/wp-content/uploads/2015/08/bulk-fw-testing-rules-02.png)
