...
As part of the NSX-T 3.0 release, an API only feature that I had discussed in a previous post ([https://www.sneaku.com/2020/03/02/how-to-sync-a-dynamic-nsx-t-group-to-an-external-system/](https://www.sneaku.com/2020/03/02/how-to-sync-a-dynamic-nsx-t-group-to-an-external-system/)), now looks like it has had the experimental flag removed, which means it is now a supported API.
