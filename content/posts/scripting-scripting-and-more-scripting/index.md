---
title: "Scripting, Scripting and more Scripting"
date: 2015-02-03
categories: 
  - "scripts"
  - "vmware"
...
In my case, I have decided to learn Python. I am not a programmer, and never will be, but I will be hosting my scripts on GitHub ([link](https://github.com/dcoghlan/)) for everyone to download, and if you want to improve one, fork it, modify it and create a pull request and we can go form there.
